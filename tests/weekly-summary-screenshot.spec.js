...
async function bootstrap(page) {
  ...
  await page.evaluate(() => {
    ...
    // both explicitly so the captured screenshot reflects only this
    // test's two-week import, not the leftover demo dataset (mirrors the
    // reset already used in img-count-check.spec.js).
    S.clashes = [];
    S.weekly = [];
